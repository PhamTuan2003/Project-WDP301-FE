          ...
          <Box component="form">
            ...
            <Grid container spacing={2} sx={{ mb: 2 }}>
              <Grid item xs={12} sm={6}>
                <Typography component="label" htmlFor="phone_number" color="text.primary" sx={{ mb: 1, fontSize: '1rem', display: 'block' }}>
                  Số điện thoại
                </Typography>
                <TextField
                  fullWidth
              ...
              <Grid item xs={12} sm={6}>
                <Typography component="label" htmlFor="reg-email" color="text.primary" sx={{ mb: 1, fontSize: '1rem', display: 'block' }}>
                  Email
                </Typography>
                <TextField
                  fullWidth
            ...
            <Box className="form-group" sx={{ mb: 2 }}>
              <Typography component="label" htmlFor="name" color="text.primary" sx={{ mb: 1, fontSize: '1rem' }}>
                Họ và tên
              </Typography>
              <TextField
                fullWidth
            ...
            <Grid container spacing={2} sx={{ mb: 2 }}>
              <Grid item xs={12} sm={6}>
                <Typography component="label" htmlFor="reg-password" color="text.primary" sx={{ mb: 1, fontSize: '1rem' }}>
                 Mật khẩu
                </Typography>
                <TextField
                  fullWidth
            ...
            <Grid item xs={12} sm={6}>
              <Typography component="label" htmlFor="confirm-password" color="text.primary" sx={{ mb: 1, fontSize: '1rem' }}>
                Xác nhận mật khẩu
              </Typography>
              <TextField
                fullWidth
