...
import { Box, Breadcrumbs, Link, Typography, Chip, Container } from '@mui/material';
...
const articles = [
  ...
  content: [
    ...
    },
    {
      ...
      image: 'https://statics.vinwonders.com/bun-moc-ha-noi-1_1687060859.jpg',
    },
    {
      ...
      image: 'https://statics.vinpearl.com/bun-moc-ha-noi-4_1687060821.jpg',
    },
    {
      ...
      image: 'https://static.vinwonders.com/production/bun-moc-ha-noi-1.jpg',
    }
  ]
},
{
  ...
  content: [
    {
      ...
      image: 'https://i1-dulich.vnecdn.net/2023/07/12/IMG-0138-1689145491.jpg?w=1200&h=0&q=100&dpr=2&fit=crop&s=wgriBgB5ZohkHPVx8j0DYA',
    },
    {
      ...
      image: 'https://i1-dulich.vnecdn.net/2023/07/12/IMG-0132-1689145502.jpg?w=1200&h=0&q=100&dpr=2&fit=crop&s=V9QuwsUZEO3QeALBKSnqBw',
    },
    {
...
},
{
  ...
  content: [
    ...
    },
    {
      ...
      image: 'https://bazaarvietnam.vn/wp-content/uploads/2025/04/harper-bazaar-cac-dia-diem-du-lich-ha-long-1-e1744295874283.jpeg',
    }
  ]
},
{
...
export default function BlogDetail() {
  ...
  return (
    <Box bgcolor="white" color="text.primary" fontFamily="sans-serif" py={3}>
      <Container maxWidth="lg">
        ...
        {/* Decorative line */}
        <Box mt={3} mb={6}>
          <Typography variant="h5" color="green" fontWeight="light" sx={{ userSelect: 'none' }}>
            * * * * * *
          </Typography>
        </Box>
          ...
          {article.content.map((section, index) => (
            <Box key={index} mb={6}>
              ...
              {section.paragraphs.map((p, i) => (
                <Typography key={i} variant="body2" color="text.secondary" mb={2} lineHeight={1.75}>
                  {p}
                </Typography>
              ))}
              {section.image && (
