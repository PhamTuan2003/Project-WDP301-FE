  ...
  return (
    <div>
      ...
      <div className="manage-infor-yacht container my-5">
        <ManageInforYacht idYacht={idYacht} />
      </div>
      <hr />
      <div className="manage-image container">
        <div className="">
          <Button
            onClick={() => setIsShowModalCreateImage(true)}
          ...
          <table className="table table-striped table-hover table-borderless table-primary align-middle">
            ...
            <tbody className="table-group-divider">
              {displayedImageYacht &&
                displayedImageYacht.length > 0 &&
                displayedImageYacht.map((image) => (
                  <tr key={image.idYachtImage} className="table-primary">
                    <td>
                    ...
                    <td width={300}>
                      <Row>
                        <Col md={4}>
                          <label onClick={() => handleUpdateYachtImage(image)} className="btn btn-primary">
                            Update
                          </label>
                        </Col>
                        <Col md={4}>
                          <Button onClick={() => handleDeleteImage(image.idYachtImage)} className="btn btn-danger">
                            Delete
                          </Button>
                        </Col>
                      </Row>
