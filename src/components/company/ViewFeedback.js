      ...
      <div className="table-responsive ">
        ...
        <table className="table table-striped table-hover table-borderless table-primary align-middle">
          ...
          <tbody className="table-group-divider">
            {displayedFeedback &&
              displayedFeedback.map((feddback) => (
                <tr key={feddback.idFeedback} className="table-primary">
                  <td>{feddback.starRating}</td>
                  <td>{feddback.customer.fullName}</td>
                  <td>{feddback.description}</td>
                  <td>{feddback.customer.phoneNumber}</td>
                </tr>
              ))}
          </tbody>
          <tfoot></tfoot>
