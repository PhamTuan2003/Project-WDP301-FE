                ...
                <div className="row g-0">
                  ...
                  <div className="col-md-8">
                    <div className="card-body p-4">
                      ...
                      <hr className="mt-0 mb-4" />
                      <div className="row pt-1">
                        <div className="col-9 mb-2">{profile.name}</div>
                        <div className="col-3 mb-3"></div>
                      </div>
                      <ButtonGroup>
                        <Button onClick={() => setIsShowModal(true)} className="btn btn-primary">
                          Edit
                        </Button>
                      </ButtonGroup>
                      <Link onClick={() => setShowModalChangePass(true)} className="mx-3">
                        Change Password
                      </Link>
                    </div>
                  </div>
