          ...
          <Accordion defaultActiveKey="0">
            <Accordion.Item eventKey="0">
              ...
              <Accordion.Body>
                ...
                <Button onClick={handleCreateImageRoom} className="btn btn-primary my-2">
                  Create
                </Button>
              </Accordion.Body>
            </Accordion.Item>
              ...
              {listImage &&
                listImage.map((image) => (
                  <tr key={image.idRoomImage}>
                    <td>
                      <img src={image.imageRoom} alt="image" width={200} />
                    </td>
                    <td>
                      <ButtonGroup className="d-flex " style={{ gap: 30, justifyContent: "center", marginTop: 54 }}>
                        <Button onClick={() => handleUpdateImageRoom(image.idRoomImage)} className="btn btn-light">
                          <FaPen size="1em" />
                        </Button>

                        <Button
                          onClick={() => handleDeleteImageRoom(image.idRoomImage)}
