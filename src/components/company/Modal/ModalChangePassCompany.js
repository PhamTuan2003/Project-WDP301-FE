      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
          <FormGroup>
            ...
            <FormControl type="password" value={oldPassword} onChange={(e) => setOldPassword(e.target.value)} />
          </FormGroup>
          <FormGroup>
            ...
            />
            <i
              style={{ position: "absolute", top: 113, right: 21, cursor: "pointer" }}
          ...
          <FormGroup>
            ...
            />
            <i
              style={{ position: "absolute", bottom: 25, right: 21, cursor: "pointer" }}
              className={showPassword1 === true ? "fa-regular fa-eye" : "fa-regular fa-eye-slash"}
