...
const ModalUpdateImageRoom = (props) => {
  ...
  return (
    <div>
      <Modal show={show} onHide={handleClose} backdrop="static" className="modal-add-new-yacht" autoFocus>
        <Modal.Header closeButton>
          <Modal.Title>Add New Yacht</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <div className="col-mad-12">
            <label style={{ width: "fit-content" }} className="form-label label-upload" htmlFor="labelUpdateImageRoom">
              {" "}
